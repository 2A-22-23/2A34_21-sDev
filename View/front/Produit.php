...
?>
              <li >
                  <span class="item">
                    ...
                    <img src="../Back/maryem/images/<?php echo $row['img'];?>" alt="streamlab-image" style="width: 50px; padding:10px; height:50px ">
...
?>
              <li class="divider"></li>
              <li><a class="text-center" href="commande.php">View Cart</a></li>
