...
$model = new Model();
              ...
              <tr>
                ...
                <td>
    <a href="controller/deleteD.php?j2=<?php echo $row['j2']; ?>" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a>
    <a href="editD.php?id=<?php echo $row['j2']; ?>"   onclick="return confirm('Are you sure you want to modify this record?')"class="badge badge-danger">edit</a>
</td>
                  </form>
