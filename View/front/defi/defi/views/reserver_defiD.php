...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <title>reserver_defi</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="reserver_defi.css" media="screen">
    ...
    <meta property="og:title" content="reserver_defi">
  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-header u-header" id="sec-5a0b"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-fb32">
      <div class="u-clearfix u-sheet u-sheet-1"></div>
    </section>
    <section class="u-align-center u-clearfix u-image u-shading u-section-2" id="sec-ff93" data-image-width="1920" data-image-height="1080">
            ...
            <div class="u-layout-row">
              <div class="u-size-30">
                <div class="u-layout-col">
                  <div class="u-align-left u-container-style u-layout-cell u-opacity u-opacity-90 u-size-60 u-white u-layout-cell-1">
                    <div class="u-container-layout u-container-layout-1">
                      <h1 class="u-text u-text-default u-text-1">Reserver votre Defi</h1>
...
require_once('Md.php');
                    ...
                    ?> 
<form method="POST" action="reserver_defiD.php">
    <input type="text" name="j2" placeholder="Nom">
    <input type="text" name="date" placeholder="Date">
    <input type="text" name="jeu" placeholder="Jeu">
    <input type="text" name="recompance" placeholder="Récompense">
    <input type="text" name="detail" placeholder="Détails">
    <button type="submit" name="submit">Enregistrer</button>
              ...
              <div class="u-size-30">
                <div class="u-layout-col">
                  <div class="u-align-left u-container-style u-image u-layout-cell u-right-cell u-size-60 u-image-1" src="" data-image-width="1000" data-image-height="1000">
