<?php
    ...
    Class clubC {
        ...
        function triClub()
        {
            $sql = "SELECT * FROM club order by titre";
        ...
        {
            $sql = "SELECT * FROM club where club.titre like '%$rech%' or club.type like '%$rech%' or club.fondateur like '%$rech%'";
            $db = config::getConnexion();
            try {
                $list = $db->query($sql);
                return $list;
        ...
        function sendSMS(){
            ...
            $authToken = '2b8513aa87696b9b9274eba58c4dda02';
